...
HD_PWD='C:/Users/usuario/Desktop/Vivado/Proyecto_prueba2/Proyecto_prueba2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_suma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_suma.tcl
