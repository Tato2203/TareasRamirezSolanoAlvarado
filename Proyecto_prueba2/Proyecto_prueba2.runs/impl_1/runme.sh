...
HD_PWD='C:/Users/usuario/Desktop/Vivado/Proyecto_prueba2/Proyecto_prueba2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_suma.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_suma.tcl -notrace
